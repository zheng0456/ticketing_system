  ...
  <main class="main-content">
    ...
    <div class="empty-order">
      ...
      <div class="empty-text">
        ...
        <p>您可以通过<a href="/scenery" class="link">景点预订</a>功能，来制定出行计划。</p>
      </div>
    </div>
    <!-- 温馨提示 -->
    <div class="tips">
...
const tabs = ref([
  {
    ...
    tips: [
      '门票已锁定，请在指定时间内完成网上支付。',
      '逾期未支付，系统将取消本次交易。',
      '在完成支付或取消本订单之前，您将无法预订其他景点。'
    ]
  },
  {
    name: '未使用订单',
    emptyMessage: '您没有未使用的订单哦~',
    tips: [
      '请提前到达景点，预留充足时间办理入园手续。',
      '入园前请确认景点地址和联系方式，避免误订。',
      '如需退订或改期，请在规定时间内办理。'
    ]
  },
  {
