<template>
  <div class="admin-return-ticket-container">
    <!-- 搜索和操作区域 -->
    ...
    >
      ...
      <el-table-column prop="originalTicketId" label="原车票ID" width="100" />
    ...
    >
      <div class="detail-info">
        ...
        <div class="detail-item">
          <span class="detail-label">原车票ID：</span>
          <span class="detail-value">{{ selectedRefund.originalTicketId }}</span>
        </div>
        <div class="detail-item">
          <span class="detail-label">车次：</span>
          <span class="detail-value">{{ selectedRefund.trainNumber }}</span>
        </div>
        <div class="detail-item">
          <span class="detail-label">出发站：</span>
          <span class="detail-value">{{ selectedRefund.departureStation }}</span>
        </div>
        <div class="detail-item">
          <span class="detail-label">到达站：</span>
          <span class="detail-value">{{ selectedRefund.arrivalStation }}</span>
        </div>
        <div class="detail-item">
    ...
    loadRefundList() {
      ...
      setTimeout(() => {
        ...
        this.refundList = [
          {
            id: 1,
            refundNumber: 'RT20240101001',
            originalTicketId: 101,
            trainNumber: 'G101',
          ...
          {
            id: 2,
            refundNumber: 'RT20240101002',
            originalTicketId: 102,
            trainNumber: 'D301',
          ...
          {
            id: 3,
            refundNumber: 'RT20240101003',
            originalTicketId: 103,
            trainNumber: 'T109',
            departureStation: '北京西站',
            arrivalStation: '上海站',
            passengerName: '王五',
            refundTime: '2024-01-01 16:45:00',
            refundReason: '临时有事',
            refundAmount: 0,
            handlingFee: 188.5,
            status: '已拒绝',
            processRemark: '距离发车时间不足24小时，按规定不予退票'
          },
          {
            id: 4,
            refundNumber: 'RT20240102001',
            originalTicketId: 104,
            trainNumber: 'K133',
