<template>
  <div class="details-ticket-container">
    <!-- 页面标题 -->
      ...
      <div class="detail-info">
        ...
        <div class="detail-row">
          <div class="detail-item">
            ...
            <span class="detail-value">{{ selectedTransaction.trainNumber }}</span>
          </div>
          <div class="detail-item">
        ...
        <div class="detail-row">
          <div class="detail-item">
            ...
            <span class="detail-value">{{ selectedTransaction.startStation }}</span>
          </div>
          <div class="detail-item">
            <span class="detail-label">到达站：</span>
            <span class="detail-value">{{ selectedTransaction.endStation }}</span>
          </div>
        </div>
        <div class="detail-row">
          <div class="detail-item">
            <span class="detail-label">发车时间：</span>
            <span class="detail-value">{{ selectedTransaction.departureTime }}</span>
          </div>
          <div class="detail-item">
            <span class="detail-label">到达时间：</span>
            <span class="detail-value">{{ selectedTransaction.arrivalTime }}</span>
          </div>
        </div>
        <div class="detail-row">
          <div class="detail-item">
        ...
        const mockData = [
          {
            ...
            startStation: '北京南',
            endStation: '上海虹桥',
            departureTime: '2024-01-05 08:00:00',
            arrivalTime: '2024-01-05 13:20:00',
          ...
          },
          {
            ...
            startStation: '广州南',
            endStation: '深圳北',
            departureTime: '2024-01-06 14:30:00',
            arrivalTime: '2024-01-06 15:00:00',
            transactionType: 'purchase',
            amount: 82,
            fee: 0,
          ...
          {
            id: 'TXN202401020001',
            orderId: 'ORD202401010003',
            trainNumber: 'Z123',
            startStation: '北京',
            endStation: '长沙',
            departureTime: '2024-01-07 21:00:00',
            arrivalTime: '2024-01-08 08:30:00',
          ...
          {
            id: 'TXN202401020002',
            orderId: 'ORD202401020001',
            trainNumber: 'D301',
            startStation: '上海',
            endStation: '武汉',
            departureTime: '2024-01-10 09:00:00',
            arrivalTime: '2024-01-10 14:45:00',
            transactionType: 'purchase',
            amount: 263,
            fee: 0,
          ...
          {
            id: 'TXN202401030001',
            orderId: 'ORD202401020002',
            trainNumber: 'G701',
            startStation: '南京南',
            endStation: '杭州东',
            departureTime: '2024-01-08 16:00:00',
            arrivalTime: '2024-01-08 17:10:00',
          ...
          {
            id: 'TXN202401040001',
            orderId: 'ORD202401040001',
            trainNumber: 'G601',
            startStation: '长沙南',
            endStation: '深圳北',
            departureTime: '2024-01-12 10:30:00',
            arrivalTime: '2024-01-12 14:20:00',
            transactionType: 'purchase',
            amount: 388,
            fee: 0,
          ...
          {
            id: 'TXN202401040002',
            orderId: 'ORD202401040002',
            trainNumber: 'K156',
            startStation: '成都',
            endStation: '重庆北',
            departureTime: '2024-01-15 16:45:00',
            arrivalTime: '2024-01-15 19:30:00',
            transactionType: 'purchase',
            amount: 46.5,
            fee: 0,
          ...
          },
          {
            ...
            startStation: '郑州东',
            endStation: '北京西',
            departureTime: '2024-01-20 07:15:00',
            arrivalTime: '2024-01-20 10:40:00',
            transactionType: 'purchase',
            amount: 309,
            fee: 0,
